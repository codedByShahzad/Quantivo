...
import { LuTag } from "react-icons/lu"; // Category icon similar to image
...
const stats = [
  ...
  },
  {
    ...
    subtitle: (
      <>
        Products <span className="text-red-500">low in stock</span>
      </>
    ),
  ...
  },
  {
    ...
    icon: <LuTag className="text-3xl text-violet-600" />,
    bg: "bg-violet-100",
    textColor: "text-slate-500",
  },
  {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between ">
        ...
        {/* Right Side */}
        <div className="relative flex items-center justify-center  md:self-auto">
           <button
                onClick={() =>
        ...
        {stats.map((item, index) => (
          ...
          >
            ...
            <div className="flex flex-col text-center md:text-left">
              <h3 className="text-md md:font-semibold text-slate-700">
                {item.title}
              </h3>

              <p className="mt-1 text-xl md:text-3xl font-semibold text-slate-900">
                {item.value}
              </p>
